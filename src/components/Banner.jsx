        ...
        <div className='pb-3 relative -z-10'>
            ...
            <div className='lg:absolute lg:w-8/12 mx-auto lg:px-0 px-2 lg:top-[25%] lg:left-1/2 lg:-translate-x-1/2'>
                <h1
                    ...
                    data-aos-delay="200"
                    className='lg:text-5xl text-3xl font-bold text-center text-secondary'>Hard-working part-timers <br /> until the next day</h1>
                <p
                    data-aos="fade-up"
                    data-aos-duration="800"
                    data-aos-easing="ease-out"
                    data-aos-delay="700"
                    className='lg:text-xl lg:text-white lg:w-8/12 mx-auto mt-5 text-center'>JavaScript is among the most powerful and flexible programming languages of the web. It powers the dynamic behavior on most websites, including this one.</p>
                <div
                    data-aos="fade-up"
            ...
            <div
                className='bg-primary mt-5 lg:mt-0 shadow-md lg:relative lg:top-[-30px] rounded-[25px] w-11/12 lg:w-7/12 mx-auto px-5 py-10'>
